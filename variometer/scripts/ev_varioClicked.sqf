...
_hasVario = ('FLAY_Variometer' in (weapons player) or 'FLAY_Variometer' in (weapons (vehicle player)));
...
if (_powerOn) then {
	...
	[player] execVM "\FLAY\FLAY_HangGlider\variometer\scripts\ui_variometer_hide.sqf";
} else {
