...
class CfgVehicles
{
	...
	class FLAY_HangGlider: Plane
	{
		...
		model = "FLAY\FLAY_HangGlider\hangglider2";
		ejectSpeed[] = {0,0,0};
		side = 4;
		...
		maxSpeed = 180;
		aileronSensitivity = 2.0; //0.8
		elevatorSensitivity = 0.12; // 0.1
		wheelSteeringSensitivity = 0.7; //0.5
		noseDownCoef = 0.0025;
